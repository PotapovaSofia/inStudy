	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='prevv action-prev'></div>" :
				"<div class='prevv action-next'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='nextt action-next'></div>" :
				"<div class='nextt action-prev'></div>";
			...
			function change_time(cur_ele, direction) {
				...
				if ((cur_ele && cur_ele.hasClass('action-next')) || direction === 'nextt') {
				...
				} else if ((cur_ele && cur_ele.hasClass('action-prev')) || direction === 'prevv') {
